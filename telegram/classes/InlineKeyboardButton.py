class InlineKeyboardButton:
    ...
    switch_inline_query_chosen_chat : SwitchInlineQueryChoosenChat
    ...
    def __init__(self,**kwargs):
        ...
        self.switch_inline_query_chosen_chat = SwitchInlineQueryChoosenChat(kwargs.get('switch_inline_query_chosen_chat', dict()))
